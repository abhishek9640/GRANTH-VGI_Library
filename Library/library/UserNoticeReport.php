...
<?php include('includes/header.php');?>
  <div class=row style="margin-top:20px; margin-bottom:50px;"></div>
  <?php
    $start = 0;
    $end = 1;
    $flag = 0;
    ...
    for($i = 0;$i<mysqli_num_rows($x);$i++)
    {
      ...
      echo "<a href=admin/Notice.php?n=$rs[0]><img src='admin/Photo.php?n=$rs[0]' class='img-thumbnail' style='height:180px;width:100%;'></a>";
