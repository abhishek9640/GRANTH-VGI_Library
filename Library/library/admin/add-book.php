...
$x = $o->addBooks($bookname,$category,$author,$isbn,$imgnewname,$numofbook);
if($x==1)
{
...
<div class="col-md-6">  
 ...
 <input class="form-control" type="text" name="numofbook" autocomplete="off"   required="required" />
 </div>
</div>
