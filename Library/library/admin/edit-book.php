...
$query->bindParam(':numofbook',$numofbook,PDO::PARAM_STR);
...
<div class="col-md-6">
 <div class="form-group">
 <label>Number of Books Available<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="numofbook" value="<?php echo htmlentities($result->numofbook);?>"   required="required" />
 </div></div>
