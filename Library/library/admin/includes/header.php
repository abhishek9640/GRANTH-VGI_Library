        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    ...
                    <img class="logo_img" src="assets/img/GRANTH.png" />
                </a>
                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="book_request.php">Issue New Book</a></li>
                             ...
                             <li><a href="bookreqreport.php">Book Req Report</a></li>
  <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    ...
                                    <li><a href="change-password.php">Change Password</a></li>
                                     ...
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="SuggestBookReport.php">Suggest Book Report</a></li>
