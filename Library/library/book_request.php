...
<label>Name</label>
<input class="form-control" type="text" name="fname" value="<?php echo $rs[0]; ?>" autocomplete="off" required  />
</div>

<div class="form-group">
<label>College ID</label>
<input class="form-control" type="text" name="collegeid" value="<?php echo $collegeid; ?>" autocomplete="off" required  />
</div>
<div class="form-group">
<label>Email</label>
<input class="form-control" type="email" name="email" value="<?php echo $rs[1]; ?>" autocomplete="off" required  />
</div>
<div class="form-group">
