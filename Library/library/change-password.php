...
$collegeid=$_SESSION['login'];
  $sql ="SELECT Password FROM tblstudents WHERE collegeid=:collegeid and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set Password=:newpassword where collegeid=:collegeid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':collegeid', $collegeid, PDO::PARAM_STR);
