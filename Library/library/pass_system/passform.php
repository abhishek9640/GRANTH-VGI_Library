        ...
        <form class="form-signin" action="pass_submit.php" method="post">
            <div class="form-section ">
                <div class="form-elements">
                    ...
                    <input type="text" id="inputEmail" name="name" class="form-control" value='<?php echo $uname; ?>' placeholder="Name" required disabled>
                </div>
                <div class="form-elements">
                    <label for="collegeID" class="input-label">College ID</label>
                    <input type="text" id="inputcollegeid" name="collegeid" class="form-control" value="<?php echo $id;?>" required disabled>
                </div>
                <div class="form-elements">
                    <label for="inputName" class="input-label">Room No</label>
                    <input type="text" id="inputName" name="room_no" class="form-control" placeholder="Room Number" required autofocus>
                </div>
                <div class="form-elements">
                    <label for="inputName" class="input-label">Phone Number</label>
                    <input type="text" id="inputName" name="phone_no" class="form-control" placeholder="Phone Number" required autofocus>
                </div>
                <div class="form-elements">
                    <label for="inputPassword" class="input-label">Destination Address</label>
                    <input type="text" id="inputPassword" name="destination" class="form-control" placeholder="Destination Address" required>
                </div>
                <div class="form-elements">
                    <label for="inputPassword" class="input-label">Purpose</label>
                    <input type="text" id="inputPassword" name="purpose" class="form-control" placeholder="Purpose" required>
                </div>
                <div class="form-elements">
